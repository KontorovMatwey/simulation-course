В данно работе представлен клеточный автомат, имитирующий процесс роста и сгорания некоторого участка леса. Далее я распишу алгоритм работы этой системы:
...
Random rnd — используется повсюду.
...
Умножить pIgnite *= (1.0 + Math.Min(2.0, c.Fertility * 12.0)). То есть плодородие (остатки после предыдущего пожара) увеличивают шанс (там больше горючих остатков).
